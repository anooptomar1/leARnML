...
extension VirtualObject {
    ...
    static let periodicTables: [VirtualObject] = {
        let modelsURL = Bundle.main.url(forResource: "art.scnassets/periodictables", withExtension: nil)!
    ...
    static let elements: [VirtualObject] = {
        let modelsURL = Bundle.main.url(forResource: "art.scnassets/elements", withExtension: nil)!
